...
namespace Ramirez_Mackenzie_HW5
{
    public class Startup
    {
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            String connectionString = "Server=tcp:sp22ramirezmackenziehw5.database.windows.net,1433;Initial Catalog=sp22ramirezmackenziehw5;Persist Security Info=False;User ID=MISAdmin;Password=Password123!;MultipleActiveResultSets=True;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;";
